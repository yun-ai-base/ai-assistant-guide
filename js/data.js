/*
 * AI 使用智能助理 · 学习向导 — 内容数据
 * 数据时间基准：2026-07-21（综合多源实测与官方参数；由 Model Tracker workflow 每周自动检查）
...
const MODELS = [
  // ---------- 美国 ----------
  {
    ...
    type: "closed",
    region: "美国",
    version: "GPT-5.6 Sol / Terra / Luna（2026-07-09 上线）",
    context: "100 万+ tokens",
    strengths: ["Sol 旗舰推理与编码最强", "Terra 性价比均衡", "Luna 快速廉价适合高频", "跨模型 Max/Ultra 推理模式创新", "生态最成熟"],
    weakness: ["中文创意与深层文化表达弱于国产", "Sol API 价格偏高"],
    scene: "Sol → 编码 / 科研 / 复杂推理；Terra → 日常通用；Luna → 快速摘要与对话",
    forWhom: "几乎所有人的「默认主力」。Sol 给硬核任务，Terra 日常用，Luna 省钱高频。",
    tip: "难任务切 Max 推理模式（让模型多想一会儿），极复杂任务切 Ultra 并行多 Agent。",
    stack: "搭配 ChatGPT Agent / Codex，配 PPTX·XLSX Skill 出办公文档。",
    price: "Sol $5/$30 · Terra $2.5/$15 · Luna $1/$6 每百万 token",
    tag: "全能均衡"
  },
  {
    id: "claude",
    name: "Opus 4.8 / Sonnet 5 / Fable 5",
    vendor: "Anthropic",
    country: "us",
    type: "closed",
    region: "美国",
    version: "Opus 4.8 / Sonnet 5 / Fable 5（2026-07）",
    context: "100 万 tokens",
    strengths: ["编程能力断层领先（Sonnet 5 63.2%/Opus 4.8 69.2% SWE-bench）", "Agent / 长程任务最强", "Fable 5 综合性能最接近 GPT-5.6 Sol", "长文档与合规写作佳"],
    weakness: ["API 成本高", "中文深层文化理解弱于国产模型"],
    scene: "大型项目开发、长程 Agent 任务、代码审查",
    forWhom: "开发者、工程师——编程和长程任务做到极致选 Opus/Fable 旗舰，日常差选用 Sonnet 5。",
    tip: "给「角色 + 约束 + 验收标准」比给「请帮我写」效果好得多；Sonnet 5 已是 Free/Pro 默认模型。",
    stack: "底层驱动 Claude Code / Cursor，配 MCP 接代码仓库与 CI 流水线。",
    price: "Sonnet 5 $2–3/$10–15 · Opus 4.8 $5/$25 · Fable 5 $10/$50 每百万 token",
    tag: "编程之王"
  },
  {
    id: "gemini",
  ...
  // ---------- 中国 ----------
  {
    ...
    type: "open",
    region: "中国",
    version: "DeepSeek V4 Pro / V4 Flash（2026-07 正式版）",
    context: "100 万 tokens（MoE 1.6 万亿 / 激活 490 亿）",
    strengths: ["数学推理顶尖（MATH-500 96.8%）", "开源、API 极低价", "SWE-bench 91.2%", "企业私有化友好", "V4 Flash 轻量高并发性价比突出"],
    weakness: ["多模态非最强项", "超长文档弱于 Kimi"],
    scene: "数理科研、数据分析、企业私有化部署、批量编程",
    forWhom: "开发者、科研、企业私有化——预算敏感又想要强推理的人首选。Pro 重推理，Flash 重并发。",
    tip: "高峰时段（9-12/14-18）价格翻倍，缓存命中时 Flash 输入低至 $0.0028/百万 token；自部署用 vLLM / Ollama。",
    stack: "是本地 OpenClaw / Hermes 的默认引擎，配 Codex 做云端并行。",
    price: "Pro $0.87(高峰 $1.74) · Flash $0.28(高峰 $0.56) 每百万 token",
    tag: "开源性价比王"
  },
  {
    id: "qwen",
  ...
  },
  {
    ...
    type: "open",
    region: "中国",
    version: "Kimi K3（2026-07-17，开源 2.8 万亿参数）",
    context: "100 万 tokens（KDA 混合注意力机制 + Stable LatentMoE 896 专家）",
    strengths: ["全球最大开源模型（2.8 万亿参数）", "中文 Agent 编程登顶（Arena 1679 分）", "超长检索标杆（BrowseComp 91.2）", "综合仅次于 Fable 5 / GPT-5.6 Sol", "开源权重 7/27 前发布"],
    weakness: ["API 输出定价偏高（￥100/百万 token）", "算力需求大，C 端曾暂停新用户"],
    scene: "编程 Agent、超长检索、中文创作、企业私有化",
    forWhom: "追求最强中文开源模型、不差算力的开发者/企业。要「全球最大开源」就选它。",
    tip: "长检索任务给 K3 最好；输出贵，尽量用长缓存命中降成本；关注 7/27 开源权重发布。",
    stack: "配 BrowseComp 做长周期检索，配 Agent 框架做编程任务。",
    price: "输入 ¥20（缓存命中 ¥2）/ 输出 ¥100 每百万 token",
    tag: "全球最大开源"
  },
  {
    id: "hunyuan",
...
const EXTENSIONS = [
  ...
  },
  {
    ...
    kind: "persona",
    personas: [
      { id: "claude", style: "严谨工程师", say: "『Opus/Sonnet/Fable 三档，编程长程任务找我最稳。』" },
      { id: "gpt", style: "全能老好人", say: "『Sol 旗舰，Terra 均衡，Luna 省钱，总有一款适合你。』" },
      { id: "deepseek", style: "性价比学霸", say: "『数学代码我强，Pro 冲性能，Flash 省成本。』" },
      { id: "doubao", style: "活泼段子手", say: "『小红书文案我拿手，语气我包了。』" },
      { id: "kimi", style: "参数巨兽", say: "『2.8 万亿参数全球最大开源，编程检索我登顶。』" },
...
const TOOLS = {
  ...
  // ② Token / 成本计算器（估算单价）
  pricing: [
    { id: "gpt", name: "GPT-5.6 Sol/Terra/Luna", perM: 5 },
    { id: "claude", name: "Opus 4.8/Sonnet 5/Fable 5", perM: 5 },
    { id: "gemini", name: "Gemini 3.1 Pro", perM: 0.3 },
    { id: "grok", name: "Grok", perM: 5 },
    { id: "deepseek", name: "DeepSeek V4 Pro/Flash", perM: 0.87 },
    { id: "qwen", name: "通义千问 Qwen3", perM: 0.6 },
    { id: "doubao", name: "豆包 Seed 2.0", perM: 0 },
    { id: "glm", name: "智谱 GLM-5.1", perM: 1.2 },
    { id: "kimi", name: "Kimi K3", perM: 2.5 },
